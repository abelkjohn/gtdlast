...
export default function AddNote(){
  ...
  return (
    <div className='flex flex-col m-4 mb-6 h-80'>
      ...
      <button className='text-white h-1/6 px-2 rounded-15 rounded-br-xl rounded-bl-xl border-none bg-blue-500  shadow-blue-500/50 shadow-lg' onClick={onSubmit}>Submit</button>
    </div>
  )
} 