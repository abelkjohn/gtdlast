...
export default function AddNote(props){
  ...
  return (
    <div className='bg-gray-200 flex flex-col m-4 mb-6 h-96 shadow-blue-500/60 shadow-xl overflow-hidden rounded-xl'>
      ...
      <button id='submit' className=' white-focus text-white text-xl h-1/6 px-2 rounded-15 rounded-br-xl rounded-bl-xl border-none bg-blue-500 shadow-blue-500/50 shadow-lg' onClick={onSubmit}>Submit</button>
    </div>
  )
} 